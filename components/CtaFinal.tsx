...
export default function CtaFinal() {
  return (
    <section style={{ textAlign: "center", padding: "100px max(2rem, calc((100vw - 1160px)/2))", background: "linear-gradient(180deg, var(--ink), var(--s1))" }}>
      <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }}>
        ...
        <h2 style={{ fontWeight: 800, fontSize: "clamp(2.5rem, 6vw, 5rem)", lineHeight: 0.96, letterSpacing: "-0.03em", marginBottom: "1rem" }}>
        ...
        <motion.a
          ...
          style={{ padding: "17px 42px", borderRadius: 10, background: "var(--blue)", color: "#fff", fontSize: 16, fontWeight: 700, textDecoration: "none", display: "inline-flex", alignItems: "center", gap: 8, boxShadow: "0 8px 28px rgba(37,99,235,0.4)" }}
        >
