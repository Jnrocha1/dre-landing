...
export default function ComoFunciona() {
  ...
  return (
    <section id="como-funciona" style={{ padding: "80px max(2rem, calc((100vw - 1160px)/2))" }}>
      ...
      <p style={{ fontSize: "0.92rem", color: "var(--t2)", maxWidth: 460, lineHeight: 1.7, marginBottom: "2rem" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "repeat(3,1fr)", gap: "1.25rem" }}>
        {STEPS.map((s, i) => (
          <motion.div key={s.n} initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.15, duration: 0.6 }}
            ...
            style={{ padding: "1.5rem", background: "rgba(0,0,0,0.25)", border: "1px solid rgba(255,255,255,0.06)", borderRadius: 13, position: "relative", cursor: "default" }}>
