...
export default function Depoimentos() {
  ...
  return (
    <section style={{ padding: "clamp(40px, 8vw, 80px) var(--px)" }}>
      ...
      <h2 style={{ fontWeight: 800, fontSize: "clamp(1.8rem, 7vw, 4rem)", lineHeight: 0.96, letterSpacing: "-0.03em", marginBottom: "2.5rem" }}>
